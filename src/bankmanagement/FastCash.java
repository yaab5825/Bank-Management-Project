...
public class FastCash extends JFrame implements ActionListener{
    ...
    FastCash(){
        ...
        l2.setBounds(950,10,60,40);
        add(l2);
        
        t1.setBounds(1030,10,60,40);
        add(t1);
        
        l1.setBounds(410,100,700,40);
        add(l1);
        
        b1.setBounds(200,250,300,60);
        add(b1);
        
        b2.setBounds(800,250,300,60);
        add(b2);
        
        b3.setBounds(200,360,300,60);
        add(b3);
        
        b4.setBounds(800,360,300,60);
        add(b4);
        
        b5.setBounds(200,470,300,60);
        add(b5);
        
        b6.setBounds(800,470,300,60);
        add(b6);
        
        b7.setBounds(500,600,300,60);
        add(b7);
