...
public class Transcations extends JFrame implements ActionListener{
    ...
    Transcations(){
        ...
        b4 = new JButton("ACCOUNT STATEMENT");
        ...
        l1.setBounds(430,100,700,40);
        add(l1);
        
        b1.setBounds(200,220,300,60);
        add(b1);
        
        b2.setBounds(800,220,300,60);
        add(b2);
        
        b3.setBounds(200,340,300,60);
        add(b3);
        
        b4.setBounds(800,340,300,60);
        add(b4);
        
        b5.setBounds(200,450,300,60);
        add(b5);
        
        b6.setBounds(800,450,300,60);
        add(b6);
        
        b7.setBounds(500,580,300,60);
        add(b7);
