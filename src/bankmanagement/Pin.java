...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(){
        ...
        l1.setBounds(500,130,800,60);
        add(l1);
        
        l2.setBounds(430,240,150,40);
        add(l2);
        
        l3.setBounds(430,300,150,40);
        add(l3);
        
        l4.setBounds(430,360,200,40);
        add(l4);
        
        t1.setBounds(630,240,360,40);
        add(t1);
        
        t2.setBounds(630,300,360,40);
        add(t2);
        
        t3.setBounds(630,360,360,40);
        add(t3);
        
        b1.setBounds(650,460,160,50);
        add(b1);
        
        b2.setBounds(850,460,160,50);
        add(b2);
